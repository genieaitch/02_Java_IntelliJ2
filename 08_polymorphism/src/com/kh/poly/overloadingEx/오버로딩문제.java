...
public class 오버로딩문제 {
    ...
    //=========================
//    1번의 경우 매개변수 타입이 달라서 적용 가능
    public void method1(String str){}

//    2번의 경우 매개변수 개수와 타입이 다르기 떄문에 적용 가능
    public void method1(int i, String str){}

//    3 기준에 작성된 method1과 타입과 개수가 같기 때문에 오버로딩 적용 불가
//  public void method1(int num){} → 타입을 추가해서 오버로딩 적용 시키기
    public void method1(int num, char c){}

//    4 기준에 작성된 method1과 매개변수의 타입, 개수가 같아서 오버로딩 적용 불가
...
//    6 2번에 작성된 메서드와 매개변수명의 타입과 순서, 개수가 모두 같아서 오버로딩 적용 불가
//    오버로딩 조건에서 매개변수명은 오버로딩이 되는 조건과 상관없음! 오직 개수와 타입만 봄
//  public void method1(int num, String string){}

//    7 오버로딩 적용 가능 매개변수명에서 자료형의 순서가 같은 게 없기 때문에 됨
