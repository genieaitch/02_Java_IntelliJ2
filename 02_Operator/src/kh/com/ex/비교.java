public 비교{
     ...
     *              택배 상자가 놓여 있는 집 주소
     *              우리가 변수에 값을 저장하면 컴퓨터는 그 값을 메모리에 저장하고, 저장된 위치를 기억
     *
     *  ==과 .equals() 의 차이 ★시험★
     *
     *      ==는 택배상자(메모리 주소)를 비교
     ...
     *      String a = "Hello";
     *      String b = "hello";
     *      a.equalsIgnorreCase(b); //true
     *      b.equalsIgnorreCase("hi"); //false
     *
     *      .equals() .equalsIgnorreCase() 차이
     *
     *      .equals() = 문자열 내용이 대소문자까지 정확히 일치해야함
     *                  아이디 비밀번호 확인할 때 사용
     *      .equalsIgnorreCase() = 문자열 내용이 대소문자 구분 없이 일치로 간주
     *                              일정한 응답표기를 각자 다른 표현으로 진행할 때 사용
     */
}