...
public class Menu {
    ...
    //메서드 기본 필수 Setter Getter toString
    ...
    public boolean equals(Object o) {
        //들어온 값이 Menu 타입인지 확인, 메뉴 타입이 아니라면 같은 것인지 확인하고 비교할 이유가 업식 때문에 돌려보내기
        if (!(o instanceof Menu menu)) return false;
        //만약에 메뉴에 들어올 값이 맞음
        //id값이 같은지 확인              가격이 같은지 확인                메뉴 이름이 같은지 확인
    ...
    // 재정의해서 사용할 경우 객체 안에서 특정 필드 값이 같을 때 논리적으로 같다고 정의하고 비교 내용을 구현
    // equals에서 세부적으로 같은지를 확인
    ...
    //hash : 컴퓨터 과학에서 주로 조각내다, 잘게 자르다 라는 의미로 사용
