...
public class SwitchEx {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.print("번호를 입력하세요 : "); //유저들에게 어떤 것을 입력해야하는지 알려주는 출력물
        int abc = sc.nextInt(); //홈페이지를 이용하는 유저가 원하는 것을 입력 받고 유저가 원하는 기능 실행
        //스위치 안에 abc라는 값이 들어왔을 때 abc에 해당하는 조건 선책하고 기능 실행
        switch (abc){
            case 1:
