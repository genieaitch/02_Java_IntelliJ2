...
public class 학생기능 {
    ...
    public void addStudent() {
        ...
        /*
        지금 순서대로 앉아있지 않는 것처럼
        컴퓨터에도 생성된 학생s1 s2 s3가 순서대로 있는 것은 아님
        무조건 정렬돼서 존재하는 것도 아님 메모리 위치에 퍼져있음
        퍼져있는 s1 s2 s3를 index 0번부터 정렬시키기 위해 std1 배열을 설정한 것이고

        std1으로 인해 퍼져있던 s1 s2 s3를 정렬시킬 수 있는 것
        */
        ...
        //std1은 등록된 학생들의 목표를 만들기 위해 설정한 공간
        ...
        //    배열에 들어있는 값을 하나씩 전달받을 변수명 이용해서 어떤 값을 가져올지 확인
        //}
