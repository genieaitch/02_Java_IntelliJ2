...
public class Snack기능 {
    ...
    public void addSnack(){
        ...
        //과자 정보를 목록으로 저장하는 배열리스트 소환
        ArrayList<Snack> snacks = new ArrayList<Snack>();
        snacks.add(snack1); //과자 목록들에 새로 입력받은 과자 한 개에 대한 정보를 저장
        snacks.add(snack2); //과자 목록들에 새로 입력받은 과자 한 개에 대한 정보를 저장
        snacks.add(snack3); //과자 목록들에 새로 입력받은 과자 한 개에 대한 정보를 저장
        ...
        /*
        준비물 : size() length 대신에 size()를 이용해서 몇 개 들어있는지 확인
        모두 출력이 아니라 모두 출력을 하되, 한 줄 씩 출력이 되길 원함
        향상된 for문을 이용해서 모두 출력
        */
    }
}
