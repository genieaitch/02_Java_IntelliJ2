...
public class BookService {
    ...
    public void method1() {
        ...
        //List1 은 숫자 넣기 가능, 문자넣기 가능, 문자열 넣기 가능 모든값을 넣을 수 있음
        ArrayList list1 = new ArrayList(3); //3칸짜리 배열생성
    ...
    public void removeBook(String title) {
        ...
        boolean found = false; //책 삭제 여부를 확인하는 변수 책을 찾거나 삭제한 상태가 아니기 때문에 false
        
        for(int i = 0; i < bookList.size(); i++) {
            /*
            책 제목에서 가져온 index번호에 적혀있는 책제목에서 내가 찾고자하는 것과 똑같은 것이 존재한다면 책제목
            ...
            */
            if(bookList.get(i).getTitle().equals(title)) {
                ...
                found = true;
                break; //삭제 후 더 이상 반복할 필요가 없음
            }
        }
        //원하는 책제목을 찾지 못했다면 해당하는 책 제목을 찾을 수 없습니다. 보여주기
        //found == false 책을 찾지 못한게 맞을 경우 = true
        //found == false를 줄여서 !found
        if(!found) {
