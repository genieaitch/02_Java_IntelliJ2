...
public class MemberRun {
    public static void main(String[] args) {
        ...
        // 1과 같은 방법은 이름이나 성별이나 나이에 특정 조건이나 암호화 설정과 같은 특수 기능을 하나씩 작성해준 후 넣어줄 때 사용
        ...
        // 필수생성자 파라미터생성자 매개변수생성자 호출해서 감길자 50 남자 한 번에 넣어줄 것
        ...
        // toString 메서드를 사용해서 한 번에 모든 값 출력하기
        System.out.println("toString() 메서드 기능 재사용 결과");
        // toString도 마찬가지로 return해서 값을 가지고 있을 뿐이지 출력하라는 기능은 들어있지 않기 때문에
