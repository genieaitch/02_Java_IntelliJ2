...
public class Void메서드 {
    ...
    /*
    * 매개변수명은 지역변수로 오직 메서드 내부에서 자료형을 전달하는 변수명의 역할을 주로 하기 때문에
    * userId가 아니라 xyz라는 이름을 넣어도 되고 어떤 이름을 넣든 문제X
    * */
    ...
    */
    ...
    // 나이값을 받아오고 00 + "세 입니다"fmf method3를 이용해서 출력하기
    public void method3(int userAge){

        System.out.println(userAge + "세 입니다.");
    }

    //자료형과 매개변수가 두 개 이상 들어가는 메서드
    //이름을 문자열(String)로 받고, 나이를 int를 받는다.
    //매개변수 순서 똑같이 넣어줘야함
    ...
    public void findId(String name, String email){
        System.out.println("아이디는 khk 입니다.");
    }
}
