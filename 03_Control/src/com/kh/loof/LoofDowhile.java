...
public class LoofDowhile {
    ...
    /*
     * 기능(=method, 메소드)
     * method1() 기능은 do-while을 이용해서 0이 입력될 때까지 정수를 계속 입력 받고 0 입력 시 누적된 합계 출력
     * */
    Scanner sc = new Scanner(System.in); //반복문에 넣는 걸 지양함
    public void method1() {
        int sum = 0; //합계 누적용 변수
        ...
        do {//while문을 시작하기 전에 한 번 무조건 실행하는 공간
            ...
            sum += input;//입력한 수를 sum 변수에 계속 더하기를 진행하는 것
                        // sum 누적된 값이 얼마가 되던간에 input으로 들어온 값이 0이면 종료
