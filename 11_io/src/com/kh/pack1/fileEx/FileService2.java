...
public class FileService2 {
    ...
    public void method1(){
        /*
        System.getProperty() 는 Java에서 현재 실행중인 특정 시스템의 속성 정보를 가져오는 데 사용하는 기능
        시스템에 댛나 환경 정보나 설정 값을 얻는 데 유용

        변수이름으로 값을 담길 원한다면 변수명 맨 앞에 자료형으로 String사용
        ...
        위와 같은 내용을 확인하기 위해서는
        System.out.print를 이용해서 눈으로 확인할 수 있음
        */

        System.getProperty("user.home"); //유저 홈에 대한 정보를 가져오기만 한 상태
