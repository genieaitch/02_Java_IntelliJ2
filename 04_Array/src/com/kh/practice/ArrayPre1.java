...
public class ArrayPre1 {
    ...
    /*사용자에게 입력받은 양의 정수만큼 배열크기 할당
    1부터 입력받은 값까지 배열에 초기화한 후 출력
    배열 크기 입력 : 사용자가 숫자로 입력, 만약에 5를 입력했다면 양의 정수로 1~5까지 출력
    */
    public void practice3() {
        System.out.print("배열 크기 입력 : ");
        int size = sc.nextInt();

        // 만약 입력한 값이 양의 정수가 아니면 리턴시켜서 메서드 종료
        if (size <= 0) {
    ...
    /*길이가 5인 String 배열을 선언하고 "사과", "귤", "포도", "복숭아", "참외"로 초기화한 후 배열 인덱스를 활용해서 귤 출력하기*/
    ...
    public void practice6() {
        ...
        char[] arr = new char[14];// 123456-1234567 (14자리)
     ...
     * 단, 전화번호 앞 3자리 (국가 코드 포함)는 그대로 출력하고, 나머지 뒷자리 숫자는 '*'로 출력
    ...
    public void practice6A() {
        ...
        for (int i = 0; i < arr.length; i++) {
            System.out.print(arr[i] + " ");
            // System.out.print("+82-"+arr[i] + " "); 해당 구문은 왜 실행이 안되는것인지
        }
    }
